...
const StepUploadDocuments = ({ setFormStep }) => {
  ...
  return (
    <div className="flex flex-col w-[80%] items-center h-2/3 animate-fadeIn max-w-[600px] pb-6 pt-8 bg-white rounded-3xl min-h-[600px]">
      <div className="absolute  flex justify-center items-center  sm:top-1/2 top-[80%] sm:right-[10%] right-[5%] rounded-full bg-gray-200  cursor-pointer  hover:bg-lime-500  duration-300">
        {loading ? (
